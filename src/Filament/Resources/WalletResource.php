                ...
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        TextInput::make('balance')
                            ...
                            ->default(0)
                            ->disabled()
                            ->visible(fn (Get $get, string $operation): bool => $get('type') == WalletTypeEnum::GENERAL() && $operation !== 'create'),
                        ...
                        TextInput::make('meta.credit')
                            ...
                            ->visible(fn (Get $get): bool => $get('type') == WalletTypeEnum::CREDIT_CARD()),
                        TextInput::make('meta.total_due')
                            ...
                            ->inputMode('decimal')
                            ->default(0)
                            ->visible(fn (Get $get, string $operation): bool => $get('type') == WalletTypeEnum::CREDIT_CARD() && $operation == 'create'),
                        ...
                        Forms\Components\Toggle::make('exclude')
                            ...
                            ->default(false)
                            ->visible(fn (Get $get): bool => $get('type') === WalletTypeEnum::GENERAL()),
                    ])->columns(),
            ]);
    }
